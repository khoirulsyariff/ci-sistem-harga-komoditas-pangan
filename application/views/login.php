...
<head>
    <title>Login - Harga Komoditas Pangan</title>
    <meta charset="UTF-8">
            ...
            <div>
                ...
                <form class="login100-form validate-form" action="<?php echo base_url('login/auth'); ?>" method="post"
                    ...
                    <span class="login100-form-title p-b-26">
                        SISTEM INFORMASI <BR>HARGA KOMODITAS PANGAN
                    </span>
...
?>
                    ...
                    <div class="container-login100-form-btn">
                        <div class="wrap-login100-form-btn">
                            ...
                            <button class="btn btn-lg btn-block btn-success login100-form-btn" type="submit"
                                name="Submit" alt="sign in">
                                Login
                            </button>
                        </div>
                    </div>
